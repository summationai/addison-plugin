...
Validation is a first-class ritual: nothing should reach an executive without it. Helper: `../api/scripts/sum_api.py`.
...
- Pair with `/sum:report`: after a successful generation, offer validation proactively.
