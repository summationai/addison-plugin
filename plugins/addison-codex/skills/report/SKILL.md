...
5. **Report back**: report title/id, the saved file path (or inline markdown if short), and suggest `$addison-validate` before the user shares it externally.

## Rules

- Long generation is normal (minutes). Stream rather than poll; in Codex pair with a background shell if needed.
