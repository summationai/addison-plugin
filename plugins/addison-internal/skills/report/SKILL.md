...
5. **Report back**: report title/id, the saved file path (or inline markdown if short), and suggest `/addison-internal:validate` before the user shares it externally.
